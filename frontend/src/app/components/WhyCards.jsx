...
const WhyCards = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-10">
      <div className="bg-white px-5 py-10 border border-gray-200 hover:border-glams-pink hover:shadow-md w-full h-auto min-h-[220px] space-y-5">
      ...
      <div className="bg-white p-5 border border-gray-200 hover:border-glams-pink hover:shadow-md w-full h-auto min-h-[220px] space-y-5">
